...
<body>
    <div class="container mx-auto max-w-6xl p-8">
        <header class="flex justify-between items-center mb-12">
            <div>
                <h1 class="text-3xl font-bold" id="user-greeting">Olá! <span class="text-yellow-300">👋</span></h1>
             
            </div>
            
            <a href="/home" id="logout-button" class="py-2 px-6 rounded-xl bg-white bg-opacity-20 backdrop-blur-md shadow-lg border border-white border-opacity-30 text-gray-900 font-semibold hover:bg-opacity-30 transition-all duration-200">
                Sair
            </a>
        </header>
        ...
        <div class="p-8 rounded-3xl bg-white bg-opacity-20 backdrop-blur-md shadow-2xl border border-white border-opacity-30 text-center mb-8 text-gray-900 card-content">
            <h2 class="text-4xl font-bold mb-2" id="user-points">0 Pontos</h2>
            <p class="text-lg text-opacity-80 mb-6">Seu desempenho atual.</p>
            <div class="w-full bg-gray-300 rounded-full h-2.5">
                <div class="bg-blue-500 h-2.5 rounded-full" id="progress-bar" style="width: 0%;"></div>
            </div>
            <p class="text-xs text-opacity-80 mt-2" id="next-level-points">0 pontos para o próximo nível.</p>
        </div>
