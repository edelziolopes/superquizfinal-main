    <style>
        ...
        body {
            ...
            /* Gradiente de fundo animado para o efeito "não estático" */
            background: linear-gradient(135deg, #7c3aed, #4f46e5, #3b82f6, #0ea5e9);
            background-size: 400% 400%;
            animation: gradientShift 15s ease infinite; /* Animação lenta de 15s */
            min-height: 100vh;
            display: flex;
